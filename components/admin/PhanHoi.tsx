...
export default function PhanHoi(props: SliderShowProps) {
  const {
    uid,
    setUid,
    phanhoi,
  ...
  const chucnang = (
    <div className="border rounded-md m-5 p-3">
      ...
      <Popconfirm
        ...
        onConfirm={() => updAllDocument("phanhoi", { status: false })}
      >
        <div className="mx-10 my-2">
      ...
      <Popconfirm
        ...
        onConfirm={() => updAllDocument("phanhoi", { status: true })}
      >
        <div className="mx-10 my-2">
        ...
        <Form.Item label="Hình ảnh :">
          ...
          >
            ...
            <Input
              ...
              accept="image/*"
              type="file"
              onChange={(e) => uploadFile("phanhoi", e, setPhotoURL)}
            />
          </Button>
          <Input
      ...
      <div className="m-5">
        ...
        <Divider>
          <div className="flex items-center text-lg font-bold text-blue-500">
            <AiOutlinePicture className="mr-2" /> DANH SÁCH ĐỐI TÁC
          </div>
        </Divider>
      </div>
