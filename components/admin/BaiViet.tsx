...
export default function BaiViet() {
  ...
  const rows = baiviet.map((data: any) => ({
    id: data.uid,
    ten: data.ten,
    tieude: data.tieude,
    phude: data.phude,
  ...
  const chucnang = (
    <div className="border rounded-md m-5 p-3">
      ...
      <Popconfirm
        ...
        onConfirm={() => updAllDocument("baiviet", { status: false })}
      >
        <div className="mx-10 my-2">
      ...
      <Popconfirm
        ...
        onConfirm={() => updAllDocument("baiviet", { status: true })}
      >
        <div className="mx-10 my-2">
      ...
      <div className="mx-10 my-2">
        <Popconfirm
          ...
          onConfirm={() => delAllDocument("baiviet")}
        >
        ...
        <Form.Item label="Hình ảnh :">
          ...
          >
            ...
            <Input
              ...
              accept="image/*"
              type="file"
              onChange={(e) => uploadFile("baiviet", e, setPhotoURL)}
            />
          </Button>
          <Input
